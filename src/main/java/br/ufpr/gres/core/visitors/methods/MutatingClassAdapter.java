...
public class MutatingClassAdapter extends ClassVisitor {
     ...
     * @return
     */
    protected boolean allowedToMutateMethod(int access, String methodName, String methodDescriptor, String signature, String[] exceptions) {
     ...
     * @return
     */
    private boolean equalsMethod(int access, String methodName, String methodDescriptor, String signature, String[] exceptions) {
     ...
     * @return
     */
    private boolean hashCodeMethod(int access, String methodName, String methodDescriptor, String signature, String[] exceptions) {
     ...
     * @return
     */
    private boolean toStringMethod(int access, String methodName, String methodDescriptor, String signature, String[] exceptions) {
