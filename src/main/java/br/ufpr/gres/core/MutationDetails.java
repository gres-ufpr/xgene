...
public final class MutationDetails {
    ...
    /**
     * Returns the human readable description of the mutation. This may be a constant string or may
     * provide more contextual information depending on the mutation operator.
     *
...
//  }
    /**
     * Indicates if this mutation might poison state within the jvm (e.g affect the values of static
     * variable)
     *
     ...
     * https://github.com/hcoles/pitest/issues/131 for discussion on block coverage
     *
    ...
    /**
     * Returns the index to the first instruction on which this mutation occurs. This index is
     * specific to how ASM represents the bytecode.
     *
