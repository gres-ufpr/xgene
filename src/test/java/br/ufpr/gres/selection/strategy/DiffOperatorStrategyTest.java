 ...
 */
public class DiffOperatorStrategyTest {
    ...
    public void testSomeMethod() throws IOException, ClassNotFoundException {
        ...
        for (MutationDetails mutationDetails : mutations) {
            System.out.println(mutationDetails.toString());
        }

        DiffOperatorStrategy strategy = new DiffOperatorStrategy(new ArrayList<>(mutations));

        System.out.println("\n\nInitiating the selection for the strategy " + strategy.toString() + " \n\n");
        int i = 0;
